...
2. `http://localhost:8080/sbb` 페이지 요청하기
  * ![404](../img/2024/feb/2024-02-02-springboot-structure//1.whitelabel.png)
...
2. 다시 `http://localhost:8080/sbb` URL을 요청을 보내기
  * ![500](../img/2024/feb/2024-02-02-springboot-structure/2.whitelabel500.png)
  ...
  * ![로그](../img/2024/feb/2024-02-02-springboot-structure/3.indexlog.png) 
...
4. 오류가 해결되었다면 다시 웹 브라우저에서 `http://localhost:8080/sbb` URL을 호출해보기
  * ![인덱스](../img/2024/feb/2024-02-02-springboot-structure/2024-02-05-web/4.index.png)
...
6. 브라우저에서 변경된 문자열의 출력확인하기
  * ![문장](../img/2024/feb/2024-02-02-springboot-structure/5.returntxt.png)